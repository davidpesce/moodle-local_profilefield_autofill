...
$string['csvavailableoptions'] = 'Available options: {$a}';
$string['csvcheckboxvalues'] = 'For checkbox fields, use: 1, 0, yes, no, true, false, on, or off';
...
$string['csvsuggestion'] = 'Did you mean \'{$a->suggestion}\'? Available options: {$a->options}';
...
$string['errorimportcsv'] = 'Error importing CSV: {$a}';
$string['errorimportingrow'] = 'Error importing row {$a}.';
$string['errorsavemapping'] = 'Error saving mapping: {$a}';
$string['errorupdatingrow'] = 'Error updating row {$a}.';
$string['errorvalidatefile'] = 'Error validating file: {$a}';
